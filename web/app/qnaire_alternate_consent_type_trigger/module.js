cenozoApp.defineModule( { name: 'qnaire_alternate_consent_type_trigger', models: ['add', 'list', 'view'], create: module => {
  ...
  /* ######################################################################################################## */
  cenozo.providers.factory( 'CnQnaireAlternateConsentTypeTriggerModelFactory', [
    'CnBaseModelFactory',
    ...
    function( CnBaseModelFactory,
      ...
      var object = function( root ) {
        ...
        this.addModel = CnQnaireAlternateConsentTypeTriggerAddFactory.instance( this );
        this.listModel = CnQnaireAlternateConsentTypeTriggerListFactory.instance( this );
        this.viewModel = CnQnaireAlternateConsentTypeTriggerViewFactory.instance( this, root );
        ...
        this.getMetadata = async function() {
          ...
          this.metadata.columnList.alternate_consent_type_id.enumList = response.data.reduce( ( list, item ) => {
