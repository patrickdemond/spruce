    ...
    return {
      ...
      lookupData: {
        ...
        misc: {
          ...
          submitWaitMessage: { en: 'Please wait while the questionnaire is submitted.', fr: 'Veuillez patienter pendant que nous soumettons le questionnaire.' },
          deviceWaitTitle: { en: 'Please Wait', fr: 'Veuillez patienter' },
          deviceWaitMessage: { en: 'Please wait while communicating with the device.', fr: 'Veuillez patienter pendant que nous communiquons avec l’appareil.' },
