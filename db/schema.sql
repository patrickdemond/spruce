...
CREATE TABLE IF NOT EXISTS `pine`.`qnaire_description` (
  ...
  `qnaire_id` INT(10) UNSIGNED NOT NULL,
  `language_id` INT(10) UNSIGNED NOT NULL,
  `type` ENUM('introduction', 'conclusion', 'closed', 'invitation subject', 'invitation body', 'incompatible') NOT NULL,
  `value` TEXT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `pine`.`question` (
  ...
  `rank` INT(10) UNSIGNED NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  `type` ENUM('audio', 'boolean', 'comment', 'date', 'device', 'list', 'lookup', 'number', 'number with unit', 'string', 'text') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pine`.`question_option` (
  ...
  `extra` ENUM('date', 'number', 'number with unit', 'string', 'text') NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `pine`.`response_device`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pine`.`response_device` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `response_id` INT(10) UNSIGNED NOT NULL,
