...
-- Wed 04 Sep 2019 02:19:44 PM EDT
...
-- -----------------------------------------------------
-- Table `linden`.`question_answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`question_answer` ;

CREATE TABLE IF NOT EXISTS `linden`.`question_answer` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `question_id` INT UNSIGNED NOT NULL,
