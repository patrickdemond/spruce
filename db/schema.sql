...
-- Wed 02 Oct 2019 02:36:51 PM EDT
...
-- Schema spruce
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `spruce` ;

-- -----------------------------------------------------
-- Schema spruce
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `spruce` ;
USE `cenozo` ;
...
-- -----------------------------------------------------
-- Table `spruce`.`service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`service` ;

CREATE TABLE IF NOT EXISTS `spruce`.`service` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`writelog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`writelog` ;

CREATE TABLE IF NOT EXISTS `spruce`.`writelog` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`role_has_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`role_has_service` ;

CREATE TABLE IF NOT EXISTS `spruce`.`role_has_service` (
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`setting` ;

CREATE TABLE IF NOT EXISTS `spruce`.`setting` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
...
-- Table `spruce`.`access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`access` ;

CREATE TABLE IF NOT EXISTS `spruce`.`access` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
-- Table `spruce`.`qnaire`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`qnaire` ;

CREATE TABLE IF NOT EXISTS `spruce`.`qnaire` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
-- Table `spruce`.`module`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`module` ;

CREATE TABLE IF NOT EXISTS `spruce`.`module` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- Table `spruce`.`page`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`page` ;

CREATE TABLE IF NOT EXISTS `spruce`.`page` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`question` ;

CREATE TABLE IF NOT EXISTS `spruce`.`question` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`attribute`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`attribute` ;

CREATE TABLE IF NOT EXISTS `spruce`.`attribute` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`response`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`response` ;

CREATE TABLE IF NOT EXISTS `spruce`.`response` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`response_attribute`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`response_attribute` ;

CREATE TABLE IF NOT EXISTS `spruce`.`response_attribute` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_response_attribute_response_id`
    ...
    REFERENCES `spruce`.`response` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_response_attribute_attribute_id`
    FOREIGN KEY (`attribute_id`)
    REFERENCES `spruce`.`attribute` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `spruce`.`answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`answer` ;

CREATE TABLE IF NOT EXISTS `spruce`.`answer` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `response_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`question_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`question_option` ;

CREATE TABLE IF NOT EXISTS `spruce`.`question_option` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `question_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `spruce`.`answer_has_question_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`answer_has_question_option` ;

CREATE TABLE IF NOT EXISTS `spruce`.`answer_has_question_option` (
...
USE `spruce`;
DROP procedure IF EXISTS `spruce`.`update_reqn_current_reqn_version`;
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`question_BEFORE_INSERT` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`question_BEFORE_INSERT` BEFORE INSERT ON `question` FOR EACH ROW
BEGIN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`question_BEFORE_UPDATE` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`question_BEFORE_UPDATE` BEFORE UPDATE ON `question` FOR EACH ROW
BEGIN
  -- make sure name is valid
  SELECT NEW.name RLIKE "[a-z_][a-z0-9_]*" INTO @test;
  IF( @test = 0 ) THEN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`attribute_BEFORE_INSERT` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`attribute_BEFORE_INSERT` BEFORE INSERT ON `attribute` FOR EACH ROW
BEGIN
  -- make sure name is valid
  SELECT NEW.name RLIKE "[a-z_][a-z0-9_]*" INTO @test;
  IF( @test = 0 ) THEN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`attribute_BEFORE_UPDATE` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`attribute_BEFORE_UPDATE` BEFORE UPDATE ON `attribute` FOR EACH ROW
BEGIN
  -- make sure name is valid
  SELECT NEW.name RLIKE "[a-z_][a-z0-9_]*" INTO @test;
  IF( @test = 0 ) THEN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`answer_BEFORE_UPDATE` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`answer_BEFORE_UPDATE` BEFORE UPDATE ON `answer` FOR EACH ROW
BEGIN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`question_option_BEFORE_INSERT` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`question_option_BEFORE_INSERT` BEFORE INSERT ON `question_option` FOR EACH ROW
BEGIN
  -- make sure name is valid
  SELECT NEW.name RLIKE "[a-z_][a-z0-9_]*" INTO @test;
  IF( @test = 0 ) THEN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`question_option_BEFORE_UPDATE` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`question_option_BEFORE_UPDATE` BEFORE UPDATE ON `question_option` FOR EACH ROW
BEGIN
  -- make sure name is valid
  SELECT NEW.name RLIKE "[a-z_][a-z0-9_]*" INTO @test;
  IF( @test = 0 ) THEN
...
USE `spruce`$$
DROP TRIGGER IF EXISTS `spruce`.`answer_has_question_option_AFTER_INSERT` $$
USE `spruce`$$
CREATE DEFINER = CURRENT_USER TRIGGER `spruce`.`answer_has_question_option_AFTER_INSERT` AFTER INSERT ON `answer_has_question_option` FOR EACH ROW
BEGIN
