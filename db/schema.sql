...
-- Tue 01 Oct 2019 03:07:40 PM EDT
...
-- -----------------------------------------------------
-- Table `spruce`.`requisite_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`requisite_group` ;

CREATE TABLE IF NOT EXISTS `spruce`.`requisite_group` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_requisite_group_question_id`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_requisite_group_requisite_group_id`
    FOREIGN KEY (`requisite_group_id`)
    REFERENCES `spruce`.`requisite_group` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `spruce`.`requisite`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `spruce`.`requisite` ;

CREATE TABLE IF NOT EXISTS `spruce`.`requisite` (
