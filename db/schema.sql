...
-- Fri 27 Sep 2019 02:58:32 PM EDT
...
-- Schema linden
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `linden` ;

-- -----------------------------------------------------
-- Schema linden
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `linden` ;
USE `cenozo` ;
...
-- -----------------------------------------------------
-- Table `linden`.`service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`service` ;

CREATE TABLE IF NOT EXISTS `linden`.`service` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`writelog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`writelog` ;

CREATE TABLE IF NOT EXISTS `linden`.`writelog` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`role_has_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`role_has_service` ;

CREATE TABLE IF NOT EXISTS `linden`.`role_has_service` (
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`setting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`setting` ;

CREATE TABLE IF NOT EXISTS `linden`.`setting` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
...
-- Table `linden`.`access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`access` ;

CREATE TABLE IF NOT EXISTS `linden`.`access` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
-- Table `linden`.`qnaire`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`qnaire` ;

CREATE TABLE IF NOT EXISTS `linden`.`qnaire` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
-- Table `linden`.`module`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`module` ;

CREATE TABLE IF NOT EXISTS `linden`.`module` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- Table `linden`.`page`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`page` ;

CREATE TABLE IF NOT EXISTS `linden`.`page` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`question`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`question` ;

CREATE TABLE IF NOT EXISTS `linden`.`question` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`requisite_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`requisite_group` ;

CREATE TABLE IF NOT EXISTS `linden`.`requisite_group` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`attribute`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`attribute` ;

CREATE TABLE IF NOT EXISTS `linden`.`attribute` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`requisite`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`requisite` ;

CREATE TABLE IF NOT EXISTS `linden`.`requisite` (
  ...
  CONSTRAINT `fk_requisite_attribute_id`
    ...
    REFERENCES `linden`.`attribute` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `linden`.`response`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`response` ;

CREATE TABLE IF NOT EXISTS `linden`.`response` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`response_attribute`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`response_attribute` ;

CREATE TABLE IF NOT EXISTS `linden`.`response_attribute` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- Table `linden`.`answer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`answer` ;

CREATE TABLE IF NOT EXISTS `linden`.`answer` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `response_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`question_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`question_option` ;

CREATE TABLE IF NOT EXISTS `linden`.`question_option` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `question_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `linden`.`answer_has_question_option`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `linden`.`answer_has_question_option` ;

CREATE TABLE IF NOT EXISTS `linden`.`answer_has_question_option` (
...
USE `linden`;
DROP procedure IF EXISTS `linden`.`update_reqn_current_reqn_version`;
...
USE `linden`$$
DROP TRIGGER IF EXISTS `linden`.`answer_BEFORE_UPDATE` $$
USE `linden`$$
CREATE DEFINER = CURRENT_USER TRIGGER `linden`.`answer_BEFORE_UPDATE` BEFORE UPDATE ON `answer` FOR EACH ROW
BEGIN
...
USE `linden`$$
DROP TRIGGER IF EXISTS `linden`.`answer_has_question_option_AFTER_INSERT` $$
USE `linden`$$
CREATE DEFINER = CURRENT_USER TRIGGER `linden`.`answer_has_question_option_AFTER_INSERT` AFTER INSERT ON `answer_has_question_option` FOR EACH ROW
BEGIN
