...
CREATE TABLE IF NOT EXISTS `pine`.`qnaire` (
  ...
  `beartooth_appointment_type` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pine`.`question` (
  ...
  `rank` INT(10) UNSIGNED NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  `type` ENUM('audio', 'boolean', 'comment', 'date', 'device', 'equipment', 'list', 'lookup', 'number', 'number with unit', 'string', 'text', 'time') NOT NULL,
