DROP PROCEDURE IF EXISTS patch_response_pause;
DELIMITER //
CREATE PROCEDURE patch_response_pause()
  BEGIN

    SELECT "Creating new response_pause table" AS "";
    ...
    SET @sql = CONCAT(
      "CREATE TABLE IF NOT EXISTS response_stage_pause ( ",
        ...
        "CONSTRAINT fk_response_pause_user_id ",
          "FOREIGN KEY (user_id) ",
